...
export const configurations = [
    ...
    new Configuration("MSFT", "yahoo", { notificationType: "discord" }, { discord: process.env.DISCORDWH_GENERAL }),
    ...
    new Configuration("SGD=X", "yahoo", { notificationType: "discord" }, { discord: process.env.DISCORDWH_GENERAL }),
    new Configuration("SGDMYR=X", "yahoo", { notificationType: "discord" }, { discord: process.env.DISCORDWH_GENERAL }),
    new Configuration("SGDCNY=X", "yahoo", { notificationType: "discord" }, { discord: process.env.DISCORDWH_TEST }),
    new Configuration("SGDJPY=X", "yahoo", { notificationType: "discord" }, { discord: process.env.DISCORDWH_TEST }),
]
